...
// Set the URL
curl_setopt($ch, CURLOPT_URL, 'https://pay.dezo.in/api/check-order-status');
...
<?php if ($transaction_status === 'SUCCESS') { ?>
    ...
    <?php }?>
        ...
        <div class="text-center">
            <a href="https://pay.dezo.in/ClientsPages/amiri/index.php?branch=<?=$branch?>" class="inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition duration-300">
                Make New Payment
            </a>
