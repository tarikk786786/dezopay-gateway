...
if (isset($_POST['upiapi'])) {
    $api_url = 'https://pay.dezo.in/order/create';
    ...
    $customer_email = "demo@pay.dezo.in";
    ...
    $data = [
        ...
        "redirect_url" => "https://pay.dezo.in/ClientsPages/amiri/callback.php?order_id=$randomOrderId"
    ];
