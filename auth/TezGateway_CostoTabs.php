...
<body>
    ...
    "result": {
        ...
        "payment_url": "https://pay.dezo.in/payment4/instant-pay/98a186be1ba109aa4b19ef7f1d499d3251e319ef43b8b94eb9fd17939c130a21",
        "data": {
...
class MyPaymentButton extends StatelessWidget {
  final String paymentUrl = 'https://pay.dezo.in/payment_page'; // Replace with actual URL
...
public class MainActivity : AppCompatActivity
{
    protected override void OnCreate(Bundle savedInstanceState)
    {
        ...
        payButton.Click += (sender, e) => {
            string paymentUrl = "https://pay.dezo.in/your-payment-link"; // Replace with actual URL
