...
$slq_p = "SELECT * FROM `googlepay_tokens` WHERE user_token = '$user_token' AND phoneNumber = '$merchentMobile' LIMIT 1";
...
// QR Code Image (Using QRServer API)
// $qrCodeUrl = "https://api.qrserver.com/v1/create-qr-code/?size=300x300&format=svg&data=" . urlencode($orders);
?>
