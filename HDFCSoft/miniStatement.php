...
$PAYLOAD=encrypt('{"tidList":["'.$tidList.'"],"type":"terminal","txnsType":"SaleSuccess","startDate":"'.$startDate.'","endDate":"'.$endDate.'","serviceType":"miniStatement","count":"'.$count.'"}',$aeskey,$aesiv);
$key=RsaPcs1($aeskey);
$iv=base64_encode($aesiv);
$url="https://hdfcmmp.mintoak.com/HDFC360/OneApp/V2/merchant-txn-detail";
