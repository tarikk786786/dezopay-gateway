...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $url = "https://pay.dezo.in/phnpe/user_txn.php?no=$user_token";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    // $txn_data_url = "https://pay.dezo.in/HDFCSoft/payrequest.php?sessionid=$seassion&cnumber=$customer_mobile&amount=$amount&no=$customer_mobile&tidList=$tidlist&dis=$diss";
    $txn_data_url = "https://pay.dezo.in/payment/mstatement.php?no=$customer_mobile&session=$seassion";
