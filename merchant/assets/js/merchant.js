...
function get_merchant(merchant_name, elm) {
	if(merchant_name == "SBI Merchant") {
	  ...
	  $("#amvideotut").html(` <h5 class="modal-title">Learn How to Connect Merchant </h5>
								        <p>A quick tutorial of Yono SBI connect process.</p>
								        <iframe width="330" height="200" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);  
		$(elm).html(`<div class="col-md-12 mb-2"> <label>Merchant Name</label> <select type="number" name="merchant_name" class="form-control" onchange="get_merchant(this.value,'#merchant')" required="">
        ...
        <option selected value="SBI Merchant">Yono SBI Merchant</option>
        ...
        </select> </div><div class="col-md-12 mb-2"> <label>Username</label> <input type="text" name="merchant_username" placeholder="Enter Username" class="form-control" required> </div> <div class="col-md-12 mb-2"> <label>Password</label> <input type="text" name="merchant_password" placeholder="Enter Password" class="form-control" required> </div><div class="col-md-12 mb-2"> <label>&nbsp;</label> <button type="submit" name="addmerchant" class="btn btn-primary btn-block">Add Merchant</button> </div>`);
	} else if(merchant_name == "hdfc") {
	    
	    	$(elm).html(`<div class="col-md-12 mb-2"> <label>Merchant Name</label> <select type="number" name="merchant_name" class="form-control" onchange="get_merchant(this.value,'#merchant')" required="">
        <option selected value="hdfc">HDFC Smart hub Vyapar</option>
        <option value="phonepe">Phonepe For Business</option>
        <option value="paytm">Paytm For Business</option>
        <option value="SBI Merchant">Yono SBI Merchant</option>
         ...
         <option value="quintuspay">QuintusPay</option>
        ...
        </select> </div><div class="col-md-12 mb-2"> 
    								...
    								</div><div class="col-md-12 mb-2"> <label>&nbsp;</label> <button type="submit" name="addmerchant" class="btn btn-primary btn-block">Add Merchant</button> </div>`);
	    
	  $("#amvideotut").html(` <h5 class="modal-title">Learn How to Connect Merchant </h5>
								        <p>A quick tutorial of HDFC Smart Hub Vypaar connect process.</p>
								        <iframe width="330" height="200" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);  
	    ...
	    $(elm).html(`<div class="col-md-12 mb-2"> <label>Merchant Name</label> <select type="number" name="merchant_name" class="form-control" onchange="get_merchant(this.value,'#merchant')" required="">
        <option value="hdfc">HDFC Smart hub Vyapar</option>
        <option selected value="phonepe">Phonepe For Business</option>
        <option value="paytm">Paytm For Business</option>
        <option value="SBI Merchant">Yono SBI Merchant</option>
         <option value="bharatpe">BharatPe Merchant</option>
         <option value="freecharge">Freecharge (Direct Bank Link)</option>
	    ...
	    $("#amvideotut").html(` <h5 class="modal-title">Learn How to Connect Merchant </h5>
								        <p>A quick tutorial of PhonePe Business connect process.</p>
								        <iframe width="330" height="200" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
        ...
        <option value="hdfc">HDFC Smart hub Vyapar</option>
        <option value="phonepe">Phonepe For Business</option>
        <option selected value="paytm">Paytm For Business</option>
        <option value="SBI Merchant">Yono SBI Merchant</option>
         <option value="bharatpe">BharatPe Merchant</option>
         <option value="freecharge">Freecharge (Direct Bank Link)</option>
         <option value="mobikwik">Mobikwik (Direct Bank Link)</option>
	    ...
	    $("#amvideotut").html(` <h5 class="modal-title">Learn How to Connect Merchant </h5>
								        <p>A quick tutorial of Paytm For Business connect process.</p>
								        <iframe width="330" height="200" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
        ...
        <option value="SBI Merchant">Yono SBI Merchant</option>
         <option value="bharatpe">BharatPe Merchant</option>
         <option selected value="freecharge">Freecharge (Direct Bank Link)</option>
         <option value="mobikwik">Mobikwik (Direct Bank Link)</option>
         <option value="amazonpay">Amazon Pay (Direct Bank Link)</option>
         <option value="googlepay">GooglePay Business</option>
         <option value="quintuspay">QuintusPay</option>
	    ...
	    $("#amvideotut").html(` <h5 class="modal-title">Learn How to Connect Merchant </h5>
								        <p>A quick tutorial of Freecharge connect process.</p>
								        <iframe width="330" height="200" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
        ...
        <option value="SBI Merchant">Yono SBI Merchant</option>
         <option value="bharatpe">BharatPe Merchant</option>
         <option value="freecharge">Freecharge (Direct Bank Link)</option>
         <option selected value="mobikwik">Mobikwik (Direct Bank Link)</option>
         <option value="amazonpay">Amazon Pay (Direct Bank Link)</option>
         <option value="googlepay">GooglePay Business</option>
         <option value="quintuspay">QuintusPay</option>
	    ...
	    $("#amvideotut").html(` <h5 class="modal-title">Learn How to Connect Merchant </h5>
								        <p>A quick tutorial of Mobikwik connect process.</p>
								        <iframe width="330" height="200" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
        ...
        <option value="paytm">Paytm For Business</option>
        <option value="SBI Merchant">Yono SBI Merchant</option>
         <option selected value="bharatpe">BharatPe Merchant</option>
         <option value="freecharge">Freecharge (Direct Bank Link)</option>
         <option value="mobikwik">Mobikwik (Direct Bank Link)</option>
         <option value="amazonpay">Amazon Pay (Direct Bank Link)</option>
         <option value="googlepay">GooglePay Business</option>
	    ...
	    $("#amvideotut").html(` <h5 class="modal-title">Learn How to Connect Merchant </h5>
								        <p>A quick tutorial of Bharatpe Business connect process.</p>
								        <iframe width="330" height="200" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
	
	} else if(merchant_name == "amazonpay") {
        ...
        <option value="SBI Merchant">Yono SBI Merchant</option>
         ...
         <option value="freecharge">Freecharge (Direct Bank Link)</option>
         <option value="mobikwik">Mobikwik (Direct Bank Link)</option>
         <option selected value="amazonpay">Amazon Pay (Direct Bank Link)</option>
         <option value="googlepay">GooglePay Business</option>
         <option value="quintuspay">QuintusPay</option>
	    ...
	    $("#amvideotut").html(` <h5 class="modal-title">Learn How to Connect Merchant </h5>
								        <p>A quick tutorial of Amazon pay connect process.</p>
								        <iframe width="330" height="200" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
        ...
        <option value="SBI Merchant">Yono SBI Merchant</option>
         ...
         <option value="mobikwik">Mobikwik (Direct Bank Link)</option>
         <option value="amazonpay">Amazon Pay (Direct Bank Link)</option>
         <option selected value="googlepay">GooglePay Business</option>
         <option value="quintuspay">QuintusPay</option>
	    ...
	    $("#amvideotut").html(` <h5 class="modal-title">Learn How to Connect Merchant </h5>
								        <p>A quick tutorial of Google pay business connect process.</p>
								        <iframe width="330" height="200" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
	
	} else if(merchant_name == "quintuspay") {
        ...
        <option value="SBI Merchant">Yono SBI Merchant</option>
         ...
         <option value="amazonpay">Amazon Pay (Direct Bank Link)</option>
         <option value="googlepay">GooglePay Business</option>
         <option selected value="quintuspay">QuintusPay</option>
